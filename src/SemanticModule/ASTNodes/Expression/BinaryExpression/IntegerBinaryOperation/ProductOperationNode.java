...
public class ProductOperationNode extends IntegerBinaryOperationNode
{
    public ProductOperationNode(ExpressionNode leftSide, Token binaryOperator, ExpressionNode rightSide)
    {
    ...
    {
        if (!TokenInspector.isTokenAmong(binaryOperatorToken, Token.OPERATOR_MULTIPLICATION))
    ...
    {
        super.generateCode();
        SymbolTable.appendCodeLines("MUL");
    }
}
