...
public class SumOperationNode extends IntegerBinaryOperationNode
{
    public SumOperationNode(ExpressionNode leftSide, Token binaryOperator, ExpressionNode rightSide)
    {
    ...
    {
        if (!TokenInspector.isTokenAmong(binaryOperatorToken, Token.OPERATOR_PLUS))
    ...
    {
        super.generateCode();
        SymbolTable.appendCodeLines("ADD");
    }
}
